...
import achievementslogo from "../../../ui-resources/dashboard/Bars/achievements.svg";
import achievementsSelected from "../../../ui-resources/dashboard/Bars/achievementsSelected.svg";
import socialInitiativeslogo from "../../../ui-resources/dashboard/Bars/socialInitiatives.svg";
import socialInitiativesSelected from "../../../ui-resources/dashboard/Bars/socialInitiativesSelected.svg";
        ...
        case "achievements":
            if(pageTag==message){
                return(
                    <Grid item>
                        <Button className={classes.contained_btn} onClick={() => { NavToPageS({message}) }}  disableElevation>
                        <Grid container alignItems="center">
                            <img src= {achievementsSelected} className={classes.contained_logo}/> 
                            {message}
                        </Grid>
                        </Button>
                    </Grid>
            ...
            return(
                <Grid item>
                    <Button className={classes.text_btn} onClick={() => { NavToPageS({message}) }}>
                    <Grid container alignItems="center">
                        <img src= {achievementslogo} className={classes.text_logo}/> 
                        {message}
                    </Grid>
                    </Button>
                </Grid>
        ...
        case "social Initiatives":
            if(pageTag==message){
                return(
                    <Grid item>
                        <Button className={classes.contained_btn} onClick={() => { NavToPageS({message}) }}  disableElevation>
                        <Grid container alignItems="center">
                            <img src= {socialInitiativesSelected} className={classes.contained_logo}/> 
                            {message}
                        </Grid>
                        </Button>
                    </Grid>
            ...
            return(
                <Grid item>
                    <Button className={classes.text_btn} onClick={() => { NavToPageS({message}) }}>
                        <Grid container alignItems="center">
                            <img src= {socialInitiativeslogo} className={classes.text_logo}/> 
                            {message}
                        </Grid>
                    </Button>
                </Grid>
